...
import com.line.saj.databinding.FragmentImageTypeBinding
import java.lang.RuntimeException


class ImageTypeBottomDialogFragment : BottomSheetDialogFragment(), View.OnClickListener {

    val TAG = "photoTypeFragment"

    private var listener: OnClickListener? = null
    private lateinit var binding: FragmentImageTypeBinding
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_image_type, container, false)
    ...
    private fun subscribeUi(binding: FragmentImageTypeBinding) {
    ...
    companion object {
        fun newInstance(): ImageTypeBottomDialogFragment =
            ImageTypeBottomDialogFragment().apply {
